...
const routes: Routes = [
  { path: 'login', loadChildren: () => import('./modules/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      { path: 'customer-pricing', loadChildren: () => import('./modules/customer-pricing/customer-pricing.module').then(m => m.CustomerPricingModule) },
      ...
      { path: 'production-calendar', loadChildren: () => import('./modules/production-calendar/production-calendar.module').then(m => m.ProductionCalendarModule) },
      { path: 'shop-floor', loadChildren: () => import('./modules/shop-floor/shop-floor.module').then(m => m.ShopFloorModule) },
      { path: 'mrp', loadChildren: () => import('./modules/mrp/mrp.module').then(m => m.MrpModule) },
      { path: 'work-centers', loadChildren: () => import('./modules/work-center/work-center.module').then(m => m.WorkCenterModule) },
