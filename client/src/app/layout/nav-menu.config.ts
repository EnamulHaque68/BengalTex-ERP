...
export const NAV_MENU: NavItem[] = [
...

  {
    ...
    children: [
      ...
      { title: 'Inventory ↔ GL Tie-Out', icon: 'pi pi-check-square', route: '/accounting/inventory-tie-out', permission: 'Reports.ViewFinance' },
      { title: 'Cost Centers',      icon: 'pi pi-sitemap',   route: '/accounting/cost-centers',    permission: 'Accounting.View' },
