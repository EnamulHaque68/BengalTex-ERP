    ...
    public partial class AddInventory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockOnHand", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockOnHand_RawMaterials_RawMaterialId",
                        column: x => x.RawMaterialId,
                        principalTable: "RawMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockAdjustmentLines_RawMaterials_RawMaterialId",
                        column: x => x.RawMaterialId,
                        principalTable: "RawMaterials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockAdjustmentLines_RawMaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_RawMaterialId_WarehouseId",
                table: "StockMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockOnHand_WarehouseId",
                table: "StockOnHand",
                column: "WarehouseId");
