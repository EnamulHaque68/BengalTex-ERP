...
public class DataSeeder : IDataSeeder
{
    ...
    private async Task SeedNumberingSeriesAsync(CancellationToken ct)
    {
        ...
        var series = new[]
        {
            ...
            new NumberingSeries { Code = "PFM",  Description = "Proforma Invoice",    Prefix = "BTX/PFM",  Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            // ── series that were used in code but previously un-seeded (caused "not configured") ──
            new NumberingSeries { Code = "SQ",    Description = "Supplier Quotation",  Prefix = "BTX/SQ",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "PR",    Description = "Purchase Requisition",Prefix = "BTX/PR",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "CN",    Description = "Credit Note",         Prefix = "BTX/CN",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "DBN",   Description = "Debit Note",          Prefix = "BTX/DBN",   Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "GP",    Description = "Gate Pass",           Prefix = "BTX/GP",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "JC",    Description = "Job Card",            Prefix = "BTX/JC",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "MC",    Description = "Machine",             Prefix = "BTX/MC",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "MM",    Description = "Machine Maintenance", Prefix = "BTX/MM",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "OS",    Description = "Opening Stock",       Prefix = "BTX/OS",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "BST",   Description = "Bank Statement",      Prefix = "BTX/BST",   Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "LCV",   Description = "Landed Cost Voucher", Prefix = "BTX/LCV",   Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "FA",    Description = "Fixed Asset",         Prefix = "BTX/FA",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "DEP",   Description = "Depreciation Run",    Prefix = "BTX/DEP",   Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "AUD",   Description = "Audit / CAP",         Prefix = "BTX/AUD",   Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
            new NumberingSeries { Code = "LV",    Description = "Leave Application",   Prefix = "BTX/LV",    Separator = "/", IncludeYear = true, PaddingLength = 5, ResetCycle = ResetCycle.Yearly, CurrentYear = year },
